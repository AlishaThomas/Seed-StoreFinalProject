package com.promineotech.seeds.errorhandler;
...
public class GlobalErrorHandler {
  ...
  public Map<String, Object> NoSuchElementExceptionHandler(
      NoSuchElementException e, WebRequest webRequest){
    return exceptionMessage(e, HttpStatus.NOT_FOUND, webRequest);
  }

  private Map<String, Object> exceptionMessage(NoSuchElementException e, 
